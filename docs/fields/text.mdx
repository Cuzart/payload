...
| **`hasMany`**      | Makes this field an ordered array of strings instead of just a single string.                                                                                                                       |
| **`minRows`**      | Minimum number of strings in the strings array, if `hasMany` is set to true.                                                                                                                        |
| **`maxRows`**      | Maximum number of strings in the strings array, if `hasMany` is set to true.                                                                                                    |
